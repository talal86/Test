package com.example.talalahmed.tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* if(savedInstanceState != null){
            initailValue = savedInstanceState.getString("FinalBillAmount");

        finalBillAmount = Float.valueOf(initailValue);}*/
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        outState.putString("FinalBillAmount",tvBillTotalAmount.toString());
